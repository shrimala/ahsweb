...
cd ..;
bin/behat;
bin/behat --format progress --out features/my_behat_errors_". $t .".txt;
mkdir sites/default/files/ahsweb/BehatReport;
cp features/my_behat_errors_". $t .".txt sites/default/files/ahsweb/BehatReport/;
