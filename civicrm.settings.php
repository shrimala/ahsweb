...
if (!defined('CIVICRM_UF_DSN')) {
    define( 'CIVICRM_UF_DSN', 'mysql://'.$endpoint['username']."@".$endpoint['host'].'/'.$endpoint['path'].'?new_link=true' );
}
...
if (!defined('CIVICRM_DSN')) {
    define( 'CIVICRM_DSN', 'mysql://'.$endpoint['username']."@".$endpoint['host'].'/'.$endpoint['path'].'?new_link=true' );
}
...
$civicrm_root = '/app/public/libraries/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/app/public/sites/default/files/civicrm/templates_c' );
}
...
// FIXME: This should be set from json_decode(base64_decode(getenv('PLATFORM_ROUTES')));
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://master-zj4rrk32qwbk6.eu.platform.sh/' );
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'febc78c4a58c4d2b8d9cb99ac1295413' );
}
