...
/**
 * @file
 * Contains \Drupal\migrate_nd\Plugin\migrate\source\AdminTerm.
 */
 ...
 * implemented by this class is "admin_term". This is the name that the migration
 ...
 * )
 */
class AdminTerm extends SqlBase {
  ...
  public function query() {
     ...
     * source plugin.
     */
    return $this->select('migrate_nd_admin_topic', 'met')
