...
/**
 * @file
 * Contains \Drupal\migrate_nd\Plugin\migrate\source\EventTerm.
 */
 ...
 * implemented by this class is "event_term". This is the name that the migration
 ...
 * )
 */
class EventTerm extends SqlBase {
  ...
  public function query() {
     ...
     * source plugin.
     */
    return $this->select('migrate_nd_event_topic', 'met')
