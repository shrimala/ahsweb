...
/**
 * @file
 * Contains \Drupal\migrate_nd\Plugin\migrate\source\SessionTerm.
 */
 ...
 * implemented by this class is "session_term". This is the name that the migration
 ...
 * )
 */
class SessionTerm extends SqlBase {
  ...
  public function query() {
     ...
     * source plugin.
     */
    return $this->select('migrate_nd_session_topic', 'met')
