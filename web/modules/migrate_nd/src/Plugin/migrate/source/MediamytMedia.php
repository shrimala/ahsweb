...
class MediamytMedia extends SqlBase {
  ...
  public function prepareRow(Row $row) {
    ...
    $q1 = db_query("select a.sbid from migrate_nd_mdstemp_node a, migrate_nd_sestemp_node b, migrate_nd_mdmyt_node c where c.filename=b.Recordings and b.sbid=a.sbid and c.meytbid=".addslashes($row->getSourceProperty('meytbid')) );
    foreach($q1 as $r)
      {
		$session_id=$r->sbid;
	  }   
